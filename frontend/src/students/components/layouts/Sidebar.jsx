...
const Sidebar = ({ collapsed: controlledCollapsed, mobileOpen, onMobileClose, onToggleCollapse }) => {
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            alignItems: 'center',
            justifyContent: 'center',
            boxShadow: '0 0 20px rgba(245,166,35,0.5), 0 4px 12px rgba(0,0,0,0.3)',
            cursor: 'pointer',
            zIndex: 50,
            transition: 'all 0.2s ease',
          }}
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 0 30px rgba(245,166,35,0.7), 0 4px 12px rgba(0,0,0,0.3)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = '#f5a623';
            e.currentTarget.style.transform = 'scale(1)';
            e.currentTarget.style.boxShadow = '0 0 20px rgba(245,166,35,0.5), 0 4px 12px rgba(0,0,0,0.3)';
          }}
        >
          <svg
            style={{
        ...
        <nav
          style={{
            ...
            overflowY: 'auto',
            overflowX: 'hidden',
            padding: collapsed ? '60px 8px' : '20px 12px',
          }}
        >
          {navItems.map(item => (
